...
Version  : 1.4.1
Release  : 14
URL      : https://github.com/jpype-project/jpype/releases/download/v1.4.1/JPype1-1.4.1.tar.gz
Source0  : https://github.com/jpype-project/jpype/releases/download/v1.4.1/JPype1-1.4.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666931275
